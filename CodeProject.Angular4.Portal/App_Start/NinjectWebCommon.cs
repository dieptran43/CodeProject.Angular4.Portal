...
namespace CodeProjectAngular2.Portal.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<CodeProject.Angular4.Interfaces.IUserDataService>().To<CodeProject.Angular4.Data.EntityFramework.UserDataService>();
            kernel.Bind<CodeProject.Angular4.Interfaces.ICustomerDataService>().To<CodeProject.Angular4.Data.EntityFramework.CustomerDataService>();
