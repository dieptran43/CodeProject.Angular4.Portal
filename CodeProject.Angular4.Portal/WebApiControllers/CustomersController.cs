...
using CodeProject.Angular4.Portal.TokenManagement;
using CodeProject.Angular4.Business;
using CodeProject.Angular4.Business.Common;
using System.Security.Claims;
using Ninject;

namespace CodeProject.Angular4.Portal.WebApiControllers
{
