...
namespace CodeProject.Angular4.Portal.TokenManagement
{
    public class TokenManager
    {
        ...
        public static string CreateToken(UserInformation userInformation)
        {
            ...
            var symmetricKey = GetBytes("CodeProject.Angular4.Token");
            var tokenDescriptor = new SecurityTokenDescriptor
            {

                Subject = new ClaimsIdentity(new ClaimsIdentity(claims)),
                TokenIssuerName = "CodeProject.Angular4.Token",
        ...
        public static ClaimsPrincipal ValidateToken(string tokenString)
        {
            ...
            {
                ValidIssuer = "CodeProject.Angular4.Token",
